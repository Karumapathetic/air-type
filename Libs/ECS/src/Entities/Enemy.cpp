...
namespace ECS {
    void patapataHandler(Coordinator &gCoordinator, std::uint32_t entity) {
        ...
        gCoordinator.addComponent(entity, Speed{3.0f, 0.0f, false});
    ...
    void winHandler(Coordinator &gCoordinator, std::uint32_t entity) {
        ...
        gCoordinator.addComponent(entity, Life{300.0f, 0.0f});
        gCoordinator.addComponent(entity, Speed{2.0f, 0.0f, false});
    ...
    void bugHandler(Coordinator &gCoordinator, std::uint32_t entity) {
        gCoordinator.addComponent(entity, Spacial{{2000.0f, 100.0f}, {66.5f, 68.0f}});
        gCoordinator.addComponent(entity, Power{3.0f, 0.0f});
        gCoordinator.addComponent(entity, Life{5.0f, 0.0f});
        gCoordinator.addComponent(entity, Speed{3.0f, 0.0f, false});
        gCoordinator.addComponent(entity, Images{"Libs/Graphics/assets/texture/enemy_bug.gif"});
    ...
    void wickHandler(Coordinator &gCoordinator, std::uint32_t entity) {
        ...
        gCoordinator.addComponent(entity, Speed{8.0f, 0.0f, false});
